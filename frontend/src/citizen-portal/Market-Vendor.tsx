...
export const MarketVendorsHub: FC<MarketVendorsHubProps> = ({ isCollapsed = false }) => {
  ...
  return (
    <div
      ...
      className="min-h-screen bg-slate-100 dark:bg-slate-950 font-['Segoe_UI',Tahoma,Geneva,Verdana,sans-serif] text-slate-800 dark:text-slate-100 flex flex-col antialiased relative transition-all duration-300 box-border"
    >
