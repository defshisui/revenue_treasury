        ...
        <div>
          ...
          <div className="max-w-6xl mx-auto px-4 py-8 space-y-6 relative z-0">
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 flex flex-col justify-between text-center">
              <div>
                <h3 className="text-blue-900 font-bold text-sm tracking-wider uppercase mb-1">CITY-OWNED MARKET</h3>
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-2xl border border-slate-200 w-full max-w-lg overflow-hidden">
            <div className="flex justify-between items-center px-6 py-4 border-b border-slate-200 bg-slate-50">
              <div>
                <span className="text-[10px] font-bold uppercase tracking-wider text-blue-700">QC MDAD Portal</span>
            ...
            <div className="p-6 space-y-3 max-h-[60vh] overflow-y-auto text-xs">
              {marketCategoryModal === 'cityOwned' && (
                <>
                  ...
                  >
                    <div>
                      <h4 className="font-bold text-xs text-slate-900 group-hover:text-blue-700">Submit Stall Application</h4>
                  ...
                  >
                    <div>
                      <h4 className="font-bold text-xs text-slate-900 group-hover:text-blue-700">Manage City-Owned Market Account</h4>
              ...
              {marketCategoryModal === 'hawkers' && (
                <>
                  ...
                  >
                    <div>
                      <h4 className="font-bold text-xs text-slate-900 group-hover:text-blue-700">Register Hawker Association</h4>
            ...
            <div className="flex justify-end gap-2 px-6 py-3 border-t border-slate-200 bg-slate-50">
              <button onClick={() => setMarketCategoryModal(null)} className="px-4 py-2 border border-slate-300 rounded font-semibold hover:bg-slate-100 text-xs cursor-pointer">Close Menu</button>
            </div>
          </div>
        </div>
      )}
      {submitOptionsModal && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-2xl border border-slate-200 w-full max-w-md overflow-hidden">
            <div className="flex justify-between items-center px-6 py-4 border-b border-slate-200 bg-slate-50">
              <div>
                <span className="text-[10px] font-bold uppercase tracking-wider text-blue-700">City-Owned Market</span>
                <h3 className="font-bold text-sm text-slate-800">Stall Application Options</h3>
              </div>
            ...
            <div className="p-6 space-y-3 text-xs">
              ...
              >
                <div>
                  <h4 className="font-bold text-xs text-slate-900 group-hover:text-blue-700">New Stall Application</h4>
                  <p className="text-[11px] text-slate-500">Apply for vacant public market stalls</p>
                </div>
                <span className="text-sm font-bold text-slate-400 group-hover:text-blue-700">&rarr;</span>
              </button>
            </div>
            <div className="flex justify-between items-center px-6 py-3 border-t border-slate-200 bg-slate-50 text-xs">
              ...
              <button onClick={() => setSubmitOptionsModal(false)} className="px-4 py-2 border border-slate-300 rounded font-semibold hover:bg-slate-100 cursor-pointer">Close</button>
            </div>
          </div>
        </div>
      )}
